...
def analyze(input_dir):
    ...
    for category in ['human']:
        ...
        actual_files = [path.join(input_dir, f'{category}_start_actual_easy.log'),
                        path.join(input_dir, f'{category}_start_other_easy.log'),
                        path.join(input_dir, f'{category}_start_actual_hard.log'),
                        path.join(input_dir, f'{category}_start_other_hard.log')
                        ]
